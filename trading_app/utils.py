...
# note: The Depends function is a part of FastAPI's dependency injection system
# and should be used in the parameters of FastAPI path operation functions, not directly in utility functions.
